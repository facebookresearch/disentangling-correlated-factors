...
import dent.models.encoder.burgess
import dent.models.decoder.burgess


class Model(nn.Module):
    @param('vae_burgess.latent_dim')
    def __init__(self, img_size, latent_dim, **kwargs):
        ...
        self.dist_nparams = 2
        self.encoder = dent.models.encoder.burgess.Encoder(img_size, self.latent_dim, dist_nparams=self.dist_nparams)
        self.decoder = dent.models.decoder.burgess.Decoder(img_size, self.latent_dim)
