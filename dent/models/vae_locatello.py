...
import dent.models.encoder.locatello
import dent.models.decoder.locatello


class Model(nn.Module):
    @param('vae_locatello.latent_dim')
    @param('model.encoder_decay')
    @param('model.decoder_decay')
    def __init__(self, img_size, latent_dim, encoder_decay=0., decoder_decay=0., **kwargs):
        ...
        self.dist_nparams = 2
        self.encoder = dent.models.encoder.locatello.Encoder(
            img_size, self.latent_dim, dist_nparams=self.dist_nparams)
        self.decoder = dent.models.decoder.locatello.Decoder(
