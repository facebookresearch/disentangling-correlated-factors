...
import dent.models.encoder.chen_mlp
import dent.models.decoder.chen_mlp


class Model(nn.Module):
    @param('vae_chen_mlp.latent_dim')
    def __init__(self, img_size, latent_dim, **kwargs):
        ...
        self.dist_nparams = 2
        self.encoder = dent.models.encoder.chen_mlp.Encoder(img_size, self.latent_dim, dist_nparams=self.dist_nparams)
        self.decoder = dent.models.decoder.chen_mlp.Decoder(img_size, self.latent_dim)
